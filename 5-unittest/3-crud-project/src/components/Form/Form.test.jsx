...
// Form bileşeninine diğer bileşenlerden farklı bir test yapıcaz
...
// "addUser" fronksiyonuna doğru parametreler gönderiliyor mu?
...
it('form gönderilince "addUser" doğru parmatreleri alarak çalışıyor mu?', async () => {
  ...
  // form gönderilnce addUser fonksiyonu çağrılır
